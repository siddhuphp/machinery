    ...
    <div class="col-lg-12">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <!-- Multi Columns Form -->
          <form method="post" class="row g-3" action="{{ route('store-product') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">                    
                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="short_desc">{{ old('short_desc') }}</textarea><!-- End TinyMCE Editor -->
              </div>
            </div>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">                    
                <textarea class="form-control" id="description" rows="3" name="description">{{ old('description') }}</textarea><!-- End TinyMCE Editor -->
              </div>
            </div>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">                    
                <textarea class="form-control" id="meta_desc" rows="3" name="meta_desc">{{ old('meta_desc') }}</textarea><!-- End TinyMCE Editor -->
              </div>
            </div>
